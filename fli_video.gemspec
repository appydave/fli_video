...
Gem::Specification.new do |spec|
  ...
  spec.metadata['source_code_uri']        = 'https://github.com/klueless-io/fli_video'
  spec.metadata['changelog_uri']          = 'https://github.com/klueless-io/fli_video/blob/main/CHANGELOG.md'
