  ...
  action do
    ...
    director = KDirector::Dsls::RubyGemDsl
      ...
      .data(
        ...
        application_description:    'FliVideo - Video Asset Management for Content Creators',
        ...
        main_story:                 'As a content creator, I want to create quality videos quickly, so that I can build my YouTube influence',
        copyright_date:             '2024',
        website:                    'http://appydave.com/gems/fli_video'
      )
      .github(
        active: false,
...
KManager.opts.app_name                    = 'fli_video'
